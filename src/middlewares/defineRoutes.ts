...
import { AuthController, UserController, QuestionController, AnswerController, SubscriptionController } from '@src/api/controllers';

type IController = AuthController | UserController | QuestionController | AnswerController | SubscriptionController;
